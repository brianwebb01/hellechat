...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/messageManagement.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
...
window.manageMessages = function (queryString) {
  return {
    ...
    removeFileForUpload: function removeFileForUpload(file) {
      this.filesForUpload = this.filesForUpload.filter(function (f) {
    ...
    searchThreads: function searchThreads() {
      ...
      this.records = this.unfilteredRecords;
      var options = {
        keys: ['phone_number', 'preview', 'contact.first_name', 'contact.last_name']
      };
      var fuse = new fuse_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.records, options);
      var results = fuse.search(this.searchTerm);
      this.records = results.map(function (i) {
        return i.item;
      });
    },
    selectNewMessageToResult: function selectNewMessageToResult(result) {
    ...
    searchNewMessageTo: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(this.newMessageToSearchString == "")) {
                  _context.next = 3;
                  break;
                }
              ...
              case 3:
                _context.next = 5;
                return fetch(this.urls.search_contacts, {
                  method: 'POST',
                  headers: {
                  ...
                  body: JSON.stringify({
                    'query': this.newMessageToSearchString
                  })
                })["catch"](function (err) {
      ...
      function searchNewMessageTo() {
        return _searchNewMessageTo.apply(this, arguments);
      }

      return searchNewMessageTo;
    }(),
    ...
    composeNewMessageConfirm: function composeNewMessageConfirm() {
      ...
      if (this.newMessageToSelection == null && this.newMessageToSearchString.match(e164Regex) != null) {
    ...
    closeNewMessageCompose: function closeNewMessageCompose() {
    ...
    sendMessage: function sendMessage() {
      ...
      if (this.currentThread.is_new) {
        ...
        var last = JSON.parse(JSON.stringify(this.messages[0]));
      ...
      if (this.filesForUpload.length > 0) {
        this.filesForUpload.forEach(function (f) {
          return formData.append('media[]', f);
        });
      }
    ...
    loadMessages: function () {
      var _loadMessages = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var url, response, json;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                url = "".concat(this.urls.show, "?page=").concat(this.messagesPage).replace('123', this.currentThread.phone_number);
                _context2.next = 3;
                return fetch(url, {
                  headers: {
                    'Accept': 'application/json'
    ...
    addMessages: function () {
      ...
      function addMessages() {
        return _addMessages.apply(this, arguments);
      }

      return addMessages;
    }(),
    afterMessagesAdded: function afterMessagesAdded() {
    ...
    fetchNumbers: function () {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return fetch("".concat(this.urls.numbers_index, "?page=").concat(numbersPage), {
                  headers: {
                    'Accept': 'application/json'
                  }
                })["catch"](function (err) {
      ...
      function fetchNumbers(_x) {
        return _fetchNumbers.apply(this, arguments);
      }
    ...
    scrollMessagesToBottom: function scrollMessagesToBottom() {
      setTimeout(function () {
        ...
        el.scrollTo({
          top: el.clientHeight * 100
        });
      }, 250);
    },
    openThread: function openThread(thread) {
      this.setCurrentThread(thread);
      this.threadOpen = !this.threadOpen;
    },
    setupComposerEnviornment: function setupComposerEnviornment() {
    ...
    resetCurrentThread: function resetCurrentThread() {
    ...
    sortThreads: function sortThreads() {
      this.records = this.records.sort(function (a, b) {
        var da = dayjs(a.last_updated_at),
    ...
    backToSummary: function backToSummary() {
      this.sendingFromName = null;
      this.sendingFromNumber = null;
      this.threadOpen = !this.threadOpen;
    },
    renderContact: function renderContact(thread) {
      if (!thread) return "";
      var contact = thread.contact;
    ...
    renderThreadTime: function renderThreadTime(thread) {
      if (typeof dayjs == 'function') return dayjs().diff(dayjs(thread.last_updated_at), 'day') < 1 ? dayjs(thread.last_updated_at).format('h:mm a') : dayjs(thread.last_updated_at).format('MM/DD');else return 'undefined';
    },
    renderMessageTime: function renderMessageTime(message, index) {
      if (message == undefined) return;

      if (typeof dayjs == 'function') {
        if (index == 0 || this.messages[index - 1] == undefined) return dayjs(message.created_at).format('MMM D, h:mm a');
        var from = dayjs(this.messages[index - 1].created_at);
        var diff = dayjs(message.created_at).diff(from, 'second');
        if (diff < 60) return null;else return dayjs(message.created_at).format('MMM D, h:mm a');
      } else return 'undefined';
    },
    renderPreview: function renderPreview(thread) {
      return thread.preview;
    },
    getAvatarLetters: function getAvatarLetters(thread) {
      if (!thread) return "??";
      var letters = [];
      var contact = null;
      if (thread.contact) contact = thread.contact;else {
        letters = ["?", "?"];
        return letters.join("");
      }
    ...
    confirmDelete: function confirmDelete() {
      ...
      this.beforeDelete();
      this.deleting = true;
      var deleteId = this.currentThread.id;
    ...
    markAsRead: function markAsRead(id) {
      ...
      if (this.messages[idx].read == false) {
        ...
        fetch(this.urls.update_message.replace('123', id), {
          ...
          if (response.status == 200) {//do nothing
          } else if (response.status == 422) {
            response.json().then(function (res) {
              return console.log(res.errors);
            });
    ...
    renderMessageContent: function renderMessageContent(message) {
      var result = '';

      if (message.body != null) {
        result = "<p>".concat(message.body, "</p>");
      }

      if (message.media != null) {
        message.media.forEach(function (url) {
          if (url.match(/\.(jpeg|jpg|gif|png)/) != null) {
            //image
            result += "<a href=\"".concat(url, "\" target=\"_blank\"><img src=\"").concat(url, "\" class=\"h-24 w-24\" /></a>");
          } else {
            //url that is not an image
            result += "<a href=\"".concat(url, "\">[ Link ]</a>");
          }
        });
      }
