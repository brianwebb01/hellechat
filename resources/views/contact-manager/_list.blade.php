                ...
                <template x-for="letter in Object.keys(groupedRecords)">
                    <div class="relative">
                        ...
                        <ul role="list" class="relative z-0 divide-y divide-gray-200">
                            ...
                            <template x-for="contact in groupedRecords[letter]" :key="contact.id">
                                <li @click.prevent="showRecord(contact.id);" class="bg-white">
                                    <div class="relative px-6 py-5 flex items-center space-x-3 hover:bg-gray-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
                                        ...
                                        <div class="flex-shrink-0 mr-3">
                                            ...
                                            <div x-text="getAvatarLetters(contact);" class="h-10 w-10 font-bold text-gray-800 rounded-full bg-gray-200 flex items-center justify-center font-mono">AA</div>
                                        </div>
