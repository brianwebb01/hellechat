    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class=" mx-auto  md:flex md:items-center md:justify-between md:space-x-5 max-w-7xl">
            ...
            <div class="mt-0 sm:mt-3 flex flex-wrap space-y-0  sm:space-x-3">
                ...
                <button type="button" @click="contactFormOpen = true;" class=" ml-2 h-10 inline-flex items-center p-2 pr-3 pl-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
