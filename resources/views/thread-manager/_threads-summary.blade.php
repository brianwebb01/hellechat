        ...
        <div class="h-full relative" style="min-height: 12rem">
            ...
            <div class="mb-4">
                <div class="relative">
                    ...
                    <input type="search" name="search" id="search" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-100 rounded-full p-2 border" placeholder="Search" />
                </div>
            </div>
            <div class="relative rounded-lg px-2 py-2 flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-300 mb-3 hover:bg-gray-200">
                ...
                <div class="flex-1 min-w-0">
                    <a @click.prevent="toggleThreadOpen()" href="#one" class="focus:outline-none">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-white text-xs bg-indigo-400 rounded-full px-1.5 pb-0.5 ml-2">
                                2
                            </div>
                        </div>
                    </a>
